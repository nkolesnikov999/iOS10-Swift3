...
//  ProgressBar
//
//  Created by Nikolay Kolesnikov on 01.05.17.
//  Copyright © 2017 NKPro. All rights reserved.
//
...
public class ProgressBarDraw : NSObject {
    ...
    public dynamic class func drawProgressBar(frame: CGRect = CGRect(x: 0, y: 0, width: 300, height: 16), progress: CGFloat = 131) {
